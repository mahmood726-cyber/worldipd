        #  Worldipd: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood789/-WorldIPD.git

        ## Objective

        WorldIPD is a global individual patient data meta-analysis platform implementing standardised IPD synthesis workflows across multiple therapeutic areas.
        ...
        - Code: https://github.com/mahmood789/-WorldIPD.git
        - Dashboard: https://mahmood789.github.io/-WorldIPD/
